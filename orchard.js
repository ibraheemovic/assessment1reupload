...
// creat 2d array for all orchards
...
while (acresLeft > 0){
 ...
 // if acres left to pick is less than average, only subtract whats left   
...
weeklyTonnage.push(weeklyTonnage);
...
console.log("\n Problem five")
 ...
 for(let i = 0; i < weeklyTonnageAll.length; i++){
     ...
     // loop through orchards tonnage counts
    ...
    totalPounds += weeklyTonnageAll[i][j] * 2000;
     ...
     // assignine variables per orchard
     switch (i){
         case 0:
